...
namespace PotionPopQuest.Core
{
    public static class MvpLevelCatalog
    {
        public static IReadOnlyList<LevelData> CreateLevels()
        {
            ...
            return new[]
            {
                new LevelData(1, 8, 8, 20, baseIngredients,
                    new[] { new GoalData(GoalType.CollectIngredient, 15, IngredientType.RedHerb) },
                    new StarThresholds(800, 1400, 2200), tutorialLevel: true),
                new LevelData(2, 8, 8, 22, baseIngredients,
                    new[] { new GoalData(GoalType.CollectIngredient, 20, IngredientType.BlueCrystal) },
                    new StarThresholds(1000, 1700, 2600), tutorialLevel: true),
                new LevelData(3, 8, 8, 24, baseIngredients,
                    new[] { new GoalData(GoalType.CollectIngredient, 25, IngredientType.GreenLeaf) },
                    new StarThresholds(1200, 2000, 3000), tutorialLevel: true),
                new LevelData(4, 8, 8, 25, baseIngredients,
                    new[] { new GoalData(GoalType.CreatePotion, 1) },
                    new StarThresholds(1300, 2200, 3300), tutorialLevel: true),
                new LevelData(5, 8, 8, 25, baseIngredients,
                ...
                new LevelData(10, 8, 8, 30, fireIngredients,
                    new[] { new GoalData(GoalType.RestorePotionLab, 28) },
